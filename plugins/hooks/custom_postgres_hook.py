...
class CustomPostgresHook(BaseHook):
    ...
    def bulk_load(self, table_name, file_name, delimiter:str, is_header:bool, is_replace:bool) :
        ...
        self.get_conn()
        header = 0 if is_header else None                    #is _header =true면 0, false면 None
        ...
        uri = f'postgressql://{self.user}:{self.password}@{self.host}/{self.dbname}'   
